...
public class Fragment_ngay_nay extends Fragment {
    String url="http://quangminh1997.000webhostapp.com/quanlychitieu/getdataNgayChi.php";
    String urls ="http://quangminh1997.000webhostapp.com/quanlychitieu/getdataNgayThu.php";
